...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6384)), "C:\\Users\\rejoy\\OneDrive\\Desktop\\class project\\next\\kin ( nextjs) - Copy\\app\\posts\\page.jsx"],
          
        }]
      },
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 213)), "C:\\Users\\rejoy\\OneDrive\\Desktop\\class project\\next\\kin ( nextjs) - Copy\\app\\posts\\layout.jsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8579)), "C:\\Users\\rejoy\\OneDrive\\Desktop\\class project\\next\\kin ( nextjs) - Copy\\app\\posts\\loading.jsx"],
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2250))
...
/* harmony import */ var _postsApiSlice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4540);
...
// async function getAllBlogs(data) {
//  const response = await fetch(
//    `${ApiURL}/api/v1/posts?page=${data ? data.page : 1}&limit=2`,{
//     withCredential : true
//    }
//  );
//   const res = await response.json();
//   return { blogs: res.data, pagination: res.pagination };
// }
function Posts() {
    const { blogs, pagination } = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)((state)=>state.blogs);
    // const { blogs=[], pagination } = await getAllBlogs();
    ...
    const handlePagination = (value)=>{
        ...
        dispatch((0,_postsApiSlice__WEBPACK_IMPORTED_MODULE_5__/* .getAllBlogs */ .L)({
            page
        }));
        (0,_postsApiSlice__WEBPACK_IMPORTED_MODULE_5__/* .getAllBlogs */ .L)({
            page
        });
    };
    if (blogs.length > 0) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("section", {
            className: " bg-[#fcf9fe]    theme-dark    min-h-screen",
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("main", {
                className: " xl:w-[1200px] py-10 px-5 lg:m-auto ",
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: "z ",
                        children: blogs?.map((post, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: " text-black border dark:bg-[#182c496b] dark:hover:bg-[#182c49dc] dark:text-white dark:border-[#2d2254] bg-[#fff] border-violet-200 rounded-[8px] z-10  flex  lg:mx-24 flex-col md:flex-row max-w-[400px] mx-auto md:max-w-full my-5",
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("figure", {
                                        className: "basis-2/5 z-10 flex items-stretch",
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_photo_view__WEBPACK_IMPORTED_MODULE_3__/* .PhotoProvider */ .TV, {
                                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_photo_view__WEBPACK_IMPORTED_MODULE_3__/* .PhotoView */ .HI, {
                                                src: `${_components_api_Api__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z}/public/images/posts/${post?.post_photo}`,
                                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                                    ...
                                                    placeholder: "blur",
                                                    blurDataURL: `${_components_api_Api__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z}/public/images/posts/${post?.post_photo}`,
                                                    loading: "lazy",
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        className: "pb-2 basis-3/5 p-5  dark:hover:bg-[#150f31b9] z-10 flex flex-col justify-between",
                                        children: [
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                className: "",
                                                children: [
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                className: "text-left pt-3 flex justify-between text-[17px]",
                                                children: [
                    ...
                    blogs.length > 0 ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            children: [
                                ...
                                new Array(pagination?.totalPages).fill(null).map((_, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                                                className: `join-item btn  dark:bg-violet-700 hover:dark:bg-violet-500 ${pagination.currentPage === index + 1 ? "bg-violet-700 dark:bg-violet-700 dark:hover:bg-violet-800" : "bg-violet-500 "}  hover:bg-violet-700 dark:hover:bg-violet-800 text-white border-none  z-10  hover:text-white border-violet-300`,
                                                onClick: ()=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [639,256,946,850,781,749], () => (__webpack_exec__(6513)));
